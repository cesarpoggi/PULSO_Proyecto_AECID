...
library(haven)
ASE_Intento_V4 <- 
  read_sav("C:/Users/Alejandro/Dropbox/PULSO_Proyecto_AECID/ASE_Intento_V4.sav")
```
...
```{r}
#Resumen de la cantidad de observaciones de las variables, según opción
table(ASE_Intento_V4$P104_1, useNA = "ifany")
table(ASE_Intento_V4$P105_1, useNA = "ifany")
table(ASE_Intento_V4$P106_1, useNA = "ifany")

ASE_Intento_V4$VotoxMujer <- ifelse(ASE_Intento_V4$P104_1 == 1 | 
                                      ASE_Intento_V4$P105_1 == 1 | 
                                      ASE_Intento_V4$P106_1 == 1, 1, 0)
table(ASE_Intento_V4$VotoxMujer)

table(ASE_Intento_V4[with(ASE_Intento_V4, VotoxMujer == 1),]$P107_1, useNA = "ifany")
table(ASE_Intento_V4[with(ASE_Intento_V4, VotoxMujer == 1),]$P107_2, useNA = "ifany")
```
...
```{r}
ASE_Intento_V4$P107_1[ASE_Intento_V4$VotoxMujer == 1] <- NA
ASE_Intento_V4$P107_2[ASE_Intento_V4$VotoxMujer == 1] <- NA
```
...
```{r}
#Resumen de la cantidad de observaciones de las variables, según opción
table(ASE_Intento_V4$P172_1, useNA = "ifany")
table(ASE_Intento_V4$P173_1, useNA = "ifany")
table(ASE_Intento_V4$P174_1, useNA = "ifany")
table(ASE_Intento_V4$P175_1, useNA = "ifany")
table(ASE_Intento_V4$P176_1, useNA = "ifany")
table(ASE_Intento_V4$P177_1, useNA = "ifany")
table(ASE_Intento_V4$P178_1, useNA = "ifany")
table(ASE_Intento_V4$P179_1, useNA = "ifany")
table(ASE_Intento_V4$P180_1, useNA = "ifany")
table(ASE_Intento_V4$P181_1, useNA = "ifany")


ASE_Intento_V4$nv_Redes <- ifelse(ASE_Intento_V4$P172_1 == 2 & 
                                    ASE_Intento_V4$P173_1 == 2 & 
                                    ASE_Intento_V4$P174_1 == 2 & 
                                    ASE_Intento_V4$P175_1 == 2 & 
                                    ASE_Intento_V4$P176_1 == 2 & 
                                    ASE_Intento_V4$P177_1 == 2 & 
                                    ASE_Intento_V4$P178_1 == 2 & 
                                    ASE_Intento_V4$P179_1 == 2 & 
                                    ASE_Intento_V4$P180_1 == 2 & 
                                    ASE_Intento_V4$P181_1 == 2, 1, 0)


table(ASE_Intento_V4[with(ASE_Intento_V4, nv_Redes == 1),]$P183_1, useNA = "ifany")
table(ASE_Intento_V4[with(ASE_Intento_V4, nv_Redes == 1),]$P183_2, useNA = "ifany")
table(ASE_Intento_V4[with(ASE_Intento_V4, nv_Redes == 1),]$P183_3, useNA = "ifany")
```
...
```{r}
table(ASE_Intento_V4[with(ASE_Intento_V4, P191_1 == 1 | P191_1 == 2),]$P192_1, useNA = "ifany")
table(ASE_Intento_V4[with(ASE_Intento_V4, P191_1 == 1 | P191_1 == 2),]$P193_1, useNA = "ifany")
```
