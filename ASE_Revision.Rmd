...
library(haven)
ASE_Intento_V2 <- 
  read_sav("C:/Users/Alejandro/Dropbox/PULSO_Proyecto_AECID/ASE_Intento_V2.sav")
```
...
```{r}
#Resumen de la cantidad de observaciones de las variables, según opción
table(ASE_Intento_V2$P104_1, useNA = "ifany")
table(ASE_Intento_V2$P105_1, useNA = "ifany")
table(ASE_Intento_V2$P106_1, useNA = "ifany")

ASE_Intento_V2$VotoxMujer <- ifelse(ASE_Intento_V2$P104_1 == 1 | 
                                      ASE_Intento_V2$P105_1 == 1 | 
                                      ASE_Intento_V2$P106_1 == 1, 1, 0)

table(ASE_Intento_V2[with(ASE_Intento_V2, VotoxMujer == 1),]$P107_1, useNA = "ifany")
table(ASE_Intento_V2[with(ASE_Intento_V2, VotoxMujer == 1),]$P107_2, useNA = "ifany")
```
...
```{r}
#Resumen de la cantidad de observaciones de las variables, según opción
table(ASE_Intento_V2$P172_1, useNA = "ifany")
table(ASE_Intento_V2$P173_1, useNA = "ifany")
table(ASE_Intento_V2$P174_1, useNA = "ifany")
table(ASE_Intento_V2$P175_1, useNA = "ifany")
table(ASE_Intento_V2$P176_1, useNA = "ifany")
table(ASE_Intento_V2$P177_1, useNA = "ifany")
table(ASE_Intento_V2$P178_1, useNA = "ifany")
table(ASE_Intento_V2$P179_1, useNA = "ifany")
table(ASE_Intento_V2$P180_1, useNA = "ifany")
table(ASE_Intento_V2$P181_1, useNA = "ifany")


ASE_Intento_V2$nv_Redes <- ifelse(ASE_Intento_V2$P172_1 == 2 & 
                                    ASE_Intento_V2$P173_1 == 2 & 
                                    ASE_Intento_V2$P174_1 == 2 & 
                                    ASE_Intento_V2$P175_1 == 2 & 
                                    ASE_Intento_V2$P176_1 == 2 & 
                                    ASE_Intento_V2$P177_1 == 2 & 
                                    ASE_Intento_V2$P178_1 == 2 & 
                                    ASE_Intento_V2$P179_1 == 2 & 
                                    ASE_Intento_V2$P180_1 == 2 & 
                                    ASE_Intento_V2$P181_1 == 2, 1, 0)


table(ASE_Intento_V2[with(ASE_Intento_V2, nv_Redes == 1),]$P183_1, useNA = "ifany")
table(ASE_Intento_V2[with(ASE_Intento_V2, nv_Redes == 1),]$P183_2, useNA = "ifany")
table(ASE_Intento_V2[with(ASE_Intento_V2, nv_Redes == 1),]$P183_3, useNA = "ifany")
```
...
```{r}
table(ASE_Intento_V2[with(ASE_Intento_V2, P191_1 == 1 | P191_1 == 2),]$P192_1, useNA = "ifany")
table(ASE_Intento_V2[with(ASE_Intento_V2, P191_1 == 1 | P191_1 == 2),]$P193_1, useNA = "ifany")
```
